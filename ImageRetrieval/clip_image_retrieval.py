...
class ImageRetriever(object):
    ...
    def bulid_faiss_index_from_features(self, image_features, image_names):
        ...
        if self.dstore_fp16:
            ...
            self.dstore_vals[self.dstore_idx:reduce_size + self.dstore_idx] = image_names.unsqueeze(-1).cpu().numpy().astype(np.int_)
        else:
...
if __name__ == '__main__':
    ...
    if args.verify:
        ...
        for idx in range(args.tar_id_start, args.tar_id_end+1): #CHANGED
