...
def get_gpu_memory_usage():
    ...
    total_memory = info.total / 1024 / 1024/ 1024
...
class KNN_Dstore(object):
    ...
    def setup_faiss(self, args):
        ...
        if args.dstore_fp16:
            ...
            self.vals = np.memmap(args.dstore_filename + '/vals.npy', dtype=int, mode='r', shape=(self.dstore_size, 1))
        else:
    ...
    def get_knns(self, queries, batch_size=4):
        ...
        knns = np.concatenate(indices_list, axis=1)
        dists = np.concatenate(distances_list, axis=1)
        '''
